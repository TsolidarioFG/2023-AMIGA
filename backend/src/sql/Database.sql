...
CREATE TABLE `Collaboration` (
   ...
   PRIMARY KEY (`id`),
   KEY `FKa2mmfx95unu49p5reuj34sah` (`volunteer_id`),
   CONSTRAINT `FKa2mmfx95unu49p5reuj34sah` FOREIGN KEY (`volunteer_id`) REFERENCES `Volunteer` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK
TABLES `Contract` WRITE;
/*!40000 ALTER TABLE `Contract` DISABLE KEYS */;
INSERT INTO `Contract`
VALUES (1, 'Contrato Indefinido'),
       (2, 'Contrato Temporal'),
       (3, 'Contrato Formación en Alternancia'),
...
VALUES (1, 'Afganistán'),
       ...
       (189, 'República de Sudán del Sur'),
       (190, 'Reunión'),
       (191, 'Ruanda'),
       (192, 'Rumanía'),
       (193, 'Rusia'),
       ...
       (199, 'San Marino'),
       (200, 'San Martín (Francia)'),
       (201, 'San Pedro y Miquelón'),
       (202, 'San Vicente y las Granadinas'),
       (203, 'Santa Elena'),
       (204, 'Santa Lucía'),
       (205, 'Santo Tomé y Príncipe'),
       (206, 'Senegal'),
       (207, 'Serbia'),
       (208, 'Seychelles'),
       (209, 'Sierra Leona'),
       ...
       (227, 'Territorios Australes y Antárticas Franceses'),
       (228, 'Timor Oriental'),
       (229, 'Togo'),
       (230, 'Tokelau'),
       (231, 'Tonga'),
...
LOCK
TABLES `Employment` WRITE;
/*!40000 ALTER TABLE `Employment` DISABLE KEYS */;
INSERT INTO `Employment`
VALUES (1, 'Desempleado/a'),
       (2, 'Desempleado/a de larga duración'),
       (3, 'Inactiva/o'),
       (4, 'Inactiva/o, integrada/o en los sistemas de educación o formación'),
       (5, 'Ocupada/o'),
       (6, 'Subempleado/a por insuficiencia de horas');
...
LOCK
TABLES `ExclusionFactor` WRITE;
/*!40000 ALTER TABLE `ExclusionFactor` DISABLE KEYS */;
INSERT INTO `ExclusionFactor`
VALUES (1, 'Adiciones, en proceso de rehabilitación social'),
       (2, 'Discapacidad (más del 33%)'),
       (3, 'Cargas familiares no compartidas'),
       (4, 'Emigrantes retornados'),
       (5, 'Enfermedad mental'),
       (6, 'Escasez de recursos'),
       (7, 'Exclusión territorial'),
       (8, 'Exreclusión'),
       (9, 'Inmigrantes/Refugiados'),
       (10, 'Problemas de salud'),
       (11, 'Prostitución, en proceso de abandono'),
       (12, 'Sin techo o infravivienda'),
...
VALUES (1, 'Casado/a'),
       ...
       (3, 'Separado/a'),
       (4, 'Soltero/a'),
       (5, 'Unión de hecho registrada'),
       (6, 'Unión de hecho no registrada'),
       (7, 'Viudo/a');
...
VALUES (1, 'Abegondo', 1),
       ...
       (65, 'Padrón', 1),
       (66, 'Pino (O)', 1),
       (67, 'Pobra do Caramiñal (A)', 1),
       (68, 'Ponteceso', 1),
       (69, 'Pontedeume', 1),
       (70, 'Pontes de García Rodríguez (As)', 1),
       (71, 'Porto do Son', 1),
       (72, 'Rianxo', 1),
       (73, 'Ribeira', 1),
       (74, 'Rois', 1),
       ...
       (124, 'Moaña', 2),
       (125, 'Mondariz', 2),
       (126, 'Mondariz-Balneario', 2),
       (127, 'Moraña', 2),
       (128, 'Mos', 2),
       (129, 'Neves (As)', 2),
       (130, 'Nigrán', 2),
       (131, 'Oia', 2),
       (132, 'Pazos de Borbén', 2),
       (133, 'Pontevedra', 2),
       (134, 'Porriño (O)', 2),
       (135, 'Portas', 2),
       (136, 'Poio', 2),
       (137, 'Ponteareas', 2),
       (138, 'Ponte Caldelas', 2),
       (139, 'Pontecesures', 2),
       (140, 'Redondela', 2),
       (141, 'Ribadumia', 2),
       (142, 'Rodeiro', 2),
       (143, 'Rosal (O)', 2),
       (144, 'Salceda de Caselas', 2),
       (145, 'Salvaterra de Miño', 2),
       (146, 'Sanxenxo', 2),
       (147, 'Silleda', 2),
       (148, 'Soutomaior', 2),
       (149, 'Tomiño', 2),
       ...
       (152, 'Vigo', 2),
       (153, 'Vilaboa', 2),
       (154, 'Vila de Cruces', 2),
       (155, 'Vilagarcía de Arousa', 2),
       (156, 'Vilanova de Arousa', 2),
       (157, 'Illa de Arousa (A)', 2),
       (158, 'Cerdedo-Cotobade', 2),
       (159, 'Abadín', 3),
       (160, 'Alfoz', 3),
       (161, 'Antas de Ulla', 3),
       (162, 'Baleira', 3),
       ...
       (187, 'Meira', 3),
       (188, 'Mondoñedo', 3),
       (189, 'Monforte de Lemos', 3),
       (190, 'Monterroso', 3),
       (191, 'Muras', 3),
       (192, 'Navia de Suarna', 3),
       (193, 'Negueira de Muñiz', 3),
       (194, 'Nogais (As)', 3),
       (195, 'Ourol', 3),
       (196, 'Outeiro de Rei', 3),
       (197, 'Palas de Rei', 3),
       (198, 'Pantón', 3),
       (199, 'Paradela', 3),
       (200, 'Páramo (O)', 3),
       (201, 'Pastoriza (A)', 3),
       (202, 'Pedrafita do Cebreiro', 3),
       (203, 'Pol', 3),
       (204, 'Pobra do Brollón (A)', 3),
       (205, 'Pontenova (A)', 3),
       (206, 'Portomarín', 3),
       (207, 'Quiroga', 3),
       (208, 'Ribadeo', 3),
       (209, 'Ribas de Sil', 3),
       (210, 'Ribeira de Piquín', 3),
       (211, 'Riotorto', 3),
       (212, 'Samos', 3),
       (213, 'Rábade', 3),
       (214, 'Sarria', 3),
       ...
       (230, 'Baltar', 4),
       (231, 'Bande', 4),
       (232, 'Baños de Molgas', 4),
       (233, 'Barbadás', 4),
       (234, 'Barco de Valdeorras (O)', 4),
       (235, 'Beade', 4),
       (236, 'Beariz', 4),
       (237, 'Blancos (Os)', 4),
       (238, 'Boborás', 4),
       (239, 'Bola (A)', 4),
       (240, 'Bolo (O)', 4),
       (241, 'Calvos de Randín', 4),
       (242, 'Carballeda de Valdeorras', 4),
       (243, 'Carballeda de Avia', 4),
       (244, 'Carballiño (O)', 4),
       (245, 'Cartelle', 4),
       (246, 'Castrelo do Val', 4),
       (247, 'Castrelo de Miño', 4),
       (248, 'Castro Caldelas', 4),
       (249, 'Celanova', 4),
       (250, 'Cenlle', 4),
       (251, 'Coles', 4),
       (252, 'Cortegada', 4),
       (253, 'Cualedro', 4),
       (254, 'Chandrexa de Queixa', 4),
       (255, 'Entrimo', 4),
       (256, 'Esgos', 4),
       (257, 'Xinzo de Limia', 4),
       (258, 'Gomesende', 4),
       (259, 'Gudiña (A)', 4),
       (260, 'Irixo (O)', 4),
       (261, 'Xunqueira de Ambía', 4),
       (262, 'Xunqueira de Espadanedo', 4),
       (263, 'Larouco', 4),
       (264, 'Laza', 4),
       (265, 'Leiro', 4),
       (266, 'Lobeira', 4),
       ...
       (275, 'Monterrei', 4),
       (276, 'Muíños', 4),
       (277, 'Nogueira de Ramuín', 4),
       (278, 'Oímbra', 4),
       (279, 'Ourense', 4),
       (280, 'Paderne de Allariz', 4),
       (281, 'Padrenda', 4),
       (282, 'Parada de Sil', 4),
       (283, 'Pereiro de Aguiar (O)', 4),
       (284, 'Peroxa (A)', 4),
       (285, 'Petín', 4),
       (286, 'Piñor', 4),
       (287, 'Porqueira', 4),
       (288, 'Pobra de Trives (A)', 4),
       (289, 'Pontedeva', 4),
       (290, 'Punxín', 4),
       (291, 'Quintela de Leirado', 4),
       (292, 'Rairiz de Veiga', 4),
       (293, 'Ramirás', 4),
       (294, 'Ribadavia', 4),
       (295, 'San Xoán de Río', 4),
       (296, 'Riós', 4),
       (297, 'Rúa (A)', 4),
       (298, 'Rubiá', 4),
       (299, 'San Amaro', 4),
       (300, 'San Cibrao das Viñas', 4),
       (301, 'San Cristovo de Cea', 4),
       (302, 'Sandiás', 4),
       (303, 'Sarreaus', 4),
       (304, 'Taboadela', 4),
       (305, 'Teixeira (A)', 4),
       ...
       (311, 'Viana do Bolo', 4),
       (312, 'Vilamarín', 4),
       (313, 'Vilamartín de Valdeorras', 4),
       (314, 'Vilar de Barrio', 4),
       (315, 'Vilar de Santos', 4),
       (316, 'Vilardevós', 4),
       (317, 'Vilariño de Conso', 4);
...
(
    ...
    PRIMARY KEY (`id`),
    KEY               `FKtbf745vtcvq2xqvq5cml6uaru` (`participant_id`),
    CONSTRAINT `FKtbf745vtcvq2xqvq5cml6uaru` FOREIGN KEY (`participant_id`) REFERENCES `Participant` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK
TABLES `Participant_yearList` WRITE;
...
LOCK
TABLES `Program` WRITE;
/*!40000 ALTER TABLE `Program` DISABLE KEYS */;
INSERT INTO `Program`
VALUES (1, 'PGIS SOCIOLBORAL'),
       (2, 'PGIS SOCIOJURÍDICO'),
       (3, 'IRPF SOCIOLABORAL'),
       (4, 'IRPF SOCIOJURÍDICO'),
       (5, 'OTROS PROGRAMAS IRPF'),
       (6, 'OTROS PROGRAMAS PGIS'),
       (7, 'CONVENIOS AYUNTAMIENTOS');
...
LOCK
TABLES `Studies` WRITE;
/*!40000 ALTER TABLE `Studies` DISABLE KEYS */;
INSERT INTO `Studies`
VALUES (1, 'Analfabeto/a'),
       (2, 'Estudios sen homologar'),
       (3, 'Estudios primarios incompletos'),
       (4, 'Educación Primaria'),
       (5, 'Certificado de Escolaridad'),
       (6, 'Educación Básica de Adultos'),
       (7, 'Graduado Escolar'),
       (8, 'Graduado en Educación Secundaria (ESO)'),
       (9, 'Certificados de Profesionalidad de Nivel 1 e similares'),
       (10, 'Certificados de Profesionalidad de Nivel 2 e similares'),
       (11, 'Certificados de Profesionalidad de Nivel 3 e similares'),
       (12, 'FP I / Formación Profesional de Grado Medio'),
       (13, 'FP II / Formación Profesional de Grado Superior'),
       (14, 'Bachiller'),
       (15, 'Estudios Universitarios'),
       (16, 'Másteres y Postgrados'),
       (17, 'Doctorado');
...
INSERT INTO `User`
VALUES (7, 'admin@udc.es', 'Admin', 'Admin', '$2a$10$4afatKv6WlIOUxgIV.ZcE.KlfNJOcs32fmEMwdzmJnYY9rAkBQZ1i', 1,
        'admin');
...
--
-- Table structure for table `WorkInsertion`
--

DROP TABLE IF EXISTS `WorkInsertion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `WorkInsertion`
(
    `id`              bigint NOT NULL AUTO_INCREMENT,
    `date`            date         DEFAULT NULL,
    `workField`       varchar(255) DEFAULT NULL,
    `workingDay`      varchar(255) DEFAULT NULL,
    `contract_id`     bigint       DEFAULT NULL,
    `participant_id`  bigint       DEFAULT NULL,
    `specialContract` varchar(255) DEFAULT NULL,
    PRIMARY KEY (`id`),
    KEY               `FK2bb79rbjnc9lib9cnokjbockf` (`contract_id`),
    KEY               `FK49fq1bh4qxjp6qaty6vs97kv3` (`participant_id`),
    CONSTRAINT `FK2bb79rbjnc9lib9cnokjbockf` FOREIGN KEY (`contract_id`) REFERENCES `Contract` (`id`),
    CONSTRAINT `FK49fq1bh4qxjp6qaty6vs97kv3` FOREIGN KEY (`participant_id`) REFERENCES `Participant` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `WorkInsertion`
--

LOCK
TABLES `WorkInsertion` WRITE;
/*!40000 ALTER TABLE `WorkInsertion` DISABLE KEYS */;
/*!40000 ALTER TABLE `WorkInsertion` ENABLE KEYS */;
UNLOCK
TABLES;
...
LOCK
TABLES `participant_countrie` WRITE;
...
LOCK
TABLES `participant_exclusionFactor` WRITE;
...
LOCK
TABLES `participant_language` WRITE;
...
(
    `id`                 bigint NOT NULL AUTO_INCREMENT,
    `itinerary`          bit(1) NOT NULL,
    `participant_id`     bigint DEFAULT NULL,
    `exclusionFactor_id` bigint DEFAULT NULL,
    PRIMARY KEY (`id`),
    KEY                  `FKqrijplmpk0vqqpt0ap5hy061q` (`participant_id`),
...
LOCK
TABLES `participant_program` WRITE;
...
-- Dump completed on 2023-08-20 18:16:23
